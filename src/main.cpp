...
void setup() {
  ...
  halClock.setMonthNameProvider([](const uint8_t monthIndex, const bool fullName) -> const char* {
    ...
    static constexpr StrId kFull[12] = {
        StrId::STR_MONTH_FULL_JAN, StrId::STR_MONTH_FULL_FEB, StrId::STR_MONTH_FULL_MAR, StrId::STR_MONTH_FULL_APR,
        StrId::STR_MONTH_FULL_MAY, StrId::STR_MONTH_FULL_JUN, StrId::STR_MONTH_FULL_JUL, StrId::STR_MONTH_FULL_AUG,
        StrId::STR_MONTH_FULL_SEP, StrId::STR_MONTH_FULL_OCT, StrId::STR_MONTH_FULL_NOV, StrId::STR_MONTH_FULL_DEC};
